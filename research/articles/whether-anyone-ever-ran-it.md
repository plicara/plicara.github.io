...
*The whitepaper: [Passing Is Not Shipping (PDF)](/research/papers/passing-is-not-shipping.pdf).
Data, method, and the re-run command:
[regexeval-2026](https://github.com/plicara/regexeval-2026), tagged
[`v1.0`](https://github.com/plicara/regexeval-2026/releases/tag/v1.0) as
published. Scoring by [regexbench](https://github.com/plicara/regexbench)
0.4.1.*
